package com.markus.springboot.whitelist.autoconfigure.config;
...
public class WhiteListAutoConfig {
    ...
    @Bean("whiteListJudgeAspect")
    @ConditionalOnMissingBean
    public WhiteListJudgeAspect whiteListJudgeAspect() {
        WhiteListJudgeAspect aspect = new WhiteListJudgeAspect();
        return aspect;
    }
}
